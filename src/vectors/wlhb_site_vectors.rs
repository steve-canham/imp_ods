use crate::import::rec_structs::WSiteRec;
use crate::AppError;
use sqlx::{postgres::PgQueryResult, Pool, Postgres};
use chrono::NaiveDate;

pub struct WSiteVecs {
...
impl WSiteVecs{
    ...
    pub fn add_data(&mut self, r: &WSiteRec) 
    {
    ...
    pub async fn store_data(&self, pool : &Pool<Postgres>) -> Result<PgQueryResult, AppError> {
        ...
        let sql = r#"INSERT INTO ods.wlhb_sites (ods_code, ods_name, grouping, health_geog, 
