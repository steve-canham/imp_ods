 ...
 ***************************************************************************/
 ...
 fn verify_folder_parameters(toml_folders: TomlFolderPars) -> Result<FolderPars, AppError> {
     ...
     // Check data folder first as there are no defaults for this value.
 ...
 fn verify_db_parameters(toml_database: TomlDBPars) -> Result<DBPars, AppError> {
     ...
     let db_name = check_defaulted_string (toml_database.db_name, "DB name", "nhs", "nhs");
 ...
 "#;
         ...
         assert_eq!(res.db_pars.db_name, "nhs");
     }
 ...
 "#;
         ...
         let res = populate_config_vars(&config_string).unwrap();
         assert_eq!(res.folders.data_folder_path, PathBuf::from("/home/steve/Data/MDR source data/NHS Org Data/2025 October/"));
         assert_eq!(res.folders.log_folder_path, PathBuf::from("/home/steve/Data/MDR source data/NHS Org Data/2025 October/"));
    }
