use crate::AppError;
use crate::utils;
//use crate::vectors::supp_agencies_vectors::SAVecs;
//use super::rec_structs::SARec;
...
impl SAVecs{
    ...
    pub fn add_data(&mut self, r: &SARec) 
    {
    ...
    pub async fn store_data(&self, pool : &Pool<Postgres>) -> Result<PgQueryResult, AppError> {
        ...
        let sql = r#"INSERT INTO ods.supp_agencies (ods_code, ods_name, grouping, health_geog, 
...
pub async fn import_data(data_folder: &PathBuf, source_file_name: &str, pool: &Pool<Postgres>) -> Result<(), AppError> {
    ...
    let mut dv: SAVecs = SAVecs::new(vector_size);
            
    for result in csv_rdr.deserialize() {
    
        let source: SALine = result?;
    ...
    info!("{} records processed from {} to ods.supp_agencies", i, source_file_name);
